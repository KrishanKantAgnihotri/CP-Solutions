...
//Mpow(ll passed ,ll answeryouwant,ll size ,ll exp,ll mod)
//answeryowant_first_row multiplied by your initial k terms is your final answer 
...
*/
cout<<(ans[1][0]*1+ans[1][1]*1)%MOD<<endl;
}
int main(){
    if(file)
      file_io();
